...
if __name__ == "__main__":
    ...
    # 训练模型
    print("开始训练DDIM模型...")
    ddim_model.train_model(num_epochs=5, lr=1e-4, save_path="ddim_model.pth")
